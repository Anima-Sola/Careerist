    ...
    return (
        <View style={ styles.wrapper }>
            <ScrollView style={ styles.container }>
                ...
                <Text style={ styles.text }>
                    На первый взгляд игровой процесс может показаться сложным, но на самом деле это не так. Обучающая инструкция изложена в разделе "Как играть?".
                </Text>
                <Text style={ styles.headerText }>Предыстория</Text>
                <Text style={ styles.text }>
                    Идея взята из текстовой игры, написанной для платформы ZX-Spectrum, в 80-х или 90-х годах. Когда именно, история умалчивает.
                </Text>
